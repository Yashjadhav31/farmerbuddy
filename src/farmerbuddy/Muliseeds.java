...
public class Muliseeds extends JFrame implements ActionListener {
    ...
    Muliseeds() {
        ...
        JTextArea heading = new JTextArea("Muli Seeds for Planting | ");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Kitchen | Vegetable | Hybrid | Terrace");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea(" Type Of Seed: Vegetable Quantity: 0-100 G Suitable For: Indoor & Outdoor Color:");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/47.png"));
