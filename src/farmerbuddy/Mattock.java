...
public class Mattock extends JFrame implements ActionListener {
    ...
    Mattock() {
        ...
        JTextArea heading = new JTextArea("VIZORA Heavy Duty Garden Pickaxe |");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Garden Tool Set | Gardening Essentials, Strong ");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Durable Steel Planter Accessories | Indoor & Outdoor Gardening ");
       heading3.setBounds(30, 110, 800, 30);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);
       
       JTextArea heading4 = new JTextArea("Brand	VIZORA\n" +
"Colour	Red\n" +
"Material	Metal\n" +
"Item Dimensions LxWxH	10.5 x 15 x 41 Centimeters\n" +
"Item Weight	555 Grams");
       heading4.setBounds(30, 150, 800, 80);
...
JTextArea heading5 = new JTextArea("The company’s manufacturing base in Jalandhar has put it as a bright spot \n on the World map of hand tool manufacturers. ");
       heading5.setBounds(30, 230, 800, 50);
