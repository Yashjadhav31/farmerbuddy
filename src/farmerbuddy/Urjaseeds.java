...
public class Urjaseeds extends JFrame implements ActionListener {
    ...
    Urjaseeds() {
        ...
        JTextArea heading = new JTextArea("Urja Desi Red Lalima Carrot Seeds");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Early Maturing Tropical Variety, Red Flesh");
...
"Roots are sweet and juicy\n" +
"The flesh is uniform red\n" +
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/37.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 245/-");
