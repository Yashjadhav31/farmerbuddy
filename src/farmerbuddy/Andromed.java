...
public class Andromed extends JFrame implements ActionListener {
    ...
    Andromed() {
        ...
        JTextArea heading = new JTextArea("Andor Cauliflower 'Andromeda' Seed,");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Growing Guide For Cauliflower Seeds Planting Instructions Soil Needs To Be");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea(" Very Rich In Organic Matter");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/32.png"));
