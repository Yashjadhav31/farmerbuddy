...
public class Solarpump extends JFrame implements ActionListener {
    ...
    Solarpump() {
        ...
        JTextArea heading = new JTextArea("12V Solar and DC Powered Water Pump Motor 700 L/H");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Brushless Magnetic Pump Motor Control Electronic.");
       heading2.setBounds(30, 60, 300, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Material: Plastic\n" +
"Adjustable flow range: 0-70L/h\n" +
"Working pressure: 1.5-4KG\n" +
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/44.png"));
