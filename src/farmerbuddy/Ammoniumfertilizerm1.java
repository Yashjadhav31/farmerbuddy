...
public class Ammoniumfertilizerm1 extends JFrame implements ActionListener {
    JButton back2,back1,redy;
   

    
    
    Ammoniumfertilizerm1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char45.png"));
