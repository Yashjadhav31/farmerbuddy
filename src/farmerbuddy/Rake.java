...
public class Rake extends JFrame implements ActionListener {
    ...
    Rake() {
        ...
        JTextArea heading = new JTextArea("KRUFE Heavy Duty Steel Garden Rake");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("with Long Handle Polished Handle ");
       heading2.setBounds(30, 60, 300, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Rake for Gardening | Rake for Quick Clean Up of Lawn and Yard | Garden Leaf");
       heading3.setBounds(30, 110, 800, 30);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);
       
       JTextArea heading4 = new JTextArea("HEAVY DUTY & MULTI-USE: This ideal garden rake easily rakes up clippings, \nleaves and loose lawn and garden debris without damaging plants. ");
       heading4.setBounds(30, 150, 600, 50);
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/3.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 799/-");
