...
public class potassiumferilizerh1 extends JFrame implements ActionListener {
    JButton back2,back1,redy;
   

    
    
    potassiumferilizerh1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char31.png"));
    ...
    public void actionperformed(ActionEvent ae) {
         if (ae.getSource() == back2){
            ...
            new potassiumferilizer();
                ...
                setVisible(false);
            new potassiumferilizerh2();}
           }
    
     public static void main(String[] args) {
        new potassiumferilizerh1();
    }
