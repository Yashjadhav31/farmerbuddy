...
public class potassiumferilizerm2 extends JFrame implements ActionListener {
    JButton back2,back1,redy;
   

    
    
    potassiumferilizerm2() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char34.png"));
