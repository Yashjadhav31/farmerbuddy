...
public class Sunflowerseeds extends JFrame implements ActionListener {
    ...
    Sunflowerseeds() {
        ...
        JTextArea heading = new JTextArea("Tong Garden Roasted Sunflower Kernels, 200g,");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("This Roasted Sunflower Kernels  have lower cholesterol");
       heading2.setBounds(30, 60, 300, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea(" have anti-inflammatory and antioxidant properties, \n"
               + "and reduce the risk for a whole host of diseases, including heart disease and cancer.");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/27.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 100/-");
       ...
       tab.addTab("Sunflowerseeds", null,p1);
       add(tab);
