...
public class Urea extends JFrame implements ActionListener {
    ...
    Urea() {
        ...
        JTextArea heading = new JTextArea("Water Soluble Fertilizer For Plants");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/22.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 423/-");
