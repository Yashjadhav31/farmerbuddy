...
public class Watermelon extends JFrame implements ActionListener {
    ...
    Watermelon() {
        ...
        JTextArea heading = new JTextArea("Gentex Watermelon Black Avenue PLX55 ");
...
p1.add(heading2); 
       ...
       JTextArea heading3 = new JTextArea(" Very attractive product, Maturity 65-70 days,\n" +
"\n" +
"Fruit weight of 7-9 kgs.\n" +
"\n" +
"Deep Red color.\n" +
"\n" +
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/31.png"));
