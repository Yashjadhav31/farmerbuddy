...
public class Bitterseeds extends JFrame implements ActionListener {
    ...
    Bitterseeds() {
        ...
        JTextArea heading = new JTextArea("VNR Manas Bitter Gourd Seeds, 50 Gm*2");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/36.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 175/-");
       ...
       tab.addTab("Bitterseeds", null,p1);
       add(tab);
