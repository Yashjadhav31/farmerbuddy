...
public class nitratefertilizerh1 extends JFrame implements ActionListener {
    ...
    nitratefertilizerh1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char47.png"));
