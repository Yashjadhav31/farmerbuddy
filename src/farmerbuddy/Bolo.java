...
public class Bolo extends JFrame implements ActionListener {
    ...
    Bolo() {
        ...
        JTextArea heading = new JTextArea("Cold Steel Bolo Machete 97LBM");
       heading.setBounds(50, 05, 800, 30);
       heading.setForeground(BLUE);
       heading.setFont(new Font("Tahoma", Font.BOLD, 20));
      
       p1.add(heading);
       
        JTextArea heading2 = new JTextArea(" The machete also makes a deadly improvised weapon ");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea(" It will cut, chop, slash, hack, split, scrape, scoop, hammer, dig, crush, carve, whittle,\n crack or Smash just about anything you can put in front of it.");
       heading3.setBounds(30, 110, 800, 50);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);
       
       JTextArea heading4 = new JTextArea("It can be used to kill both fish and game and will Gut, scale,\n filet, skin, quarter, and butcher them for the table as well. ");
       heading4.setBounds(30, 160, 600, 50);
...
JTextArea heading5 = new JTextArea("The company’s manufacturing base in Jalandhar has put it as a bright spot \n on the World map of hand tool manufacturers. ");
       heading5.setBounds(30, 220, 650, 80);
