...
public class Tomatoseeds extends JFrame implements ActionListener {
    ...
    Tomatoseeds() {
        ...
        JTextArea heading = new JTextArea("Urja Hybrid Tomato Seeds, Red Color Fruit,");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("With Excellent Germination Quality");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea(" Tomato is a warm-season crop and requires a relatively long growing season with ");
       heading3.setBounds(30, 110, 800, 30);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);

  JTextArea heading5 = new JTextArea("plenty of sunshine and a moderate day temperature of 20–28°C..");
       heading5.setBounds(30, 150, 600, 30);
...
p1.add(heading5);
       ...
       heading4.setBounds(30, 220, 600, 30);
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/29.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 499/-");
       ...
       tab.addTab("Tomatoseeds", null,p1);
       add(tab);
