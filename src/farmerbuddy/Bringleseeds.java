...
public class Bringleseeds extends JFrame implements ActionListener {
    ...
    Bringleseeds() {
        ...
        JTextArea heading = new JTextArea("Urja Bringle Sitara, Arka Anamika Seeds,");
...
p1.add(heading2); 
       ...
       JTextArea heading3 = new JTextArea("Tall vigorous dark purpal colored plants with an excellent shelf life.\n" +
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/49.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 250/-");
       ...
       tab.addTab("Bringleseeds", null,p1);
       add(tab);
