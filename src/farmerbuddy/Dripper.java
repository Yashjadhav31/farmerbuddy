...
public class Dripper extends JFrame implements ActionListener {
    ...
    Dripper() {
        ...
        JTextArea heading = new JTextArea("Adjustable Drippers Sprinklers Emitter");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Thread Diameter: 0.25 Inch. Plastic Material.");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/43.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 330/-");
