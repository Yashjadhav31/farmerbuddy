...
public class Pruning extends JFrame implements ActionListener {
    ...
    Pruning() {
        ...
        JTextArea heading = new JTextArea("GROWTOP Flemingo Orange Garden Shears ");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("for Garden Hand purning");
       heading2.setBounds(30, 50, 800, 120);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Made in india ");
       heading3.setBounds(30, 100, 800, 30);
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/15.png"));
