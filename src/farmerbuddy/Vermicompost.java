...
public class Vermicompost extends JFrame implements ActionListener {
    ...
    Vermicompost() {
        ...
        JTextArea heading = new JTextArea("TrustBasket Organic Vermicompost Fertilizer");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Manure For Plants 5 Kg Green ");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/20.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 219/-");
       ...
       tab.addTab("Vermicompost", null,p1);
       add(tab);
