...
public class agriculturalseed extends JFrame implements ActionListener {
    ...
    agriculturalseed() {
        ...
        JTextArea heading = new JTextArea("GREEN WORLD High Yield Black Wheat 6 kg Seed");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Early Maturing Tropical Variety, Green Flesh");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea(" Early maturing tropical variety\n" +
"Roots are juicy\n" +
"The flesh is uniform green\n" +
"Root length – 30 to 35cms");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/46.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 145/-");
       ...
       tab.addTab("agriculturalseed", null,p1);
       add(tab);
