...
public class calciumfertilizerh2 extends JFrame implements ActionListener {
    ...
    calciumfertilizerh2() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char38.png"));
