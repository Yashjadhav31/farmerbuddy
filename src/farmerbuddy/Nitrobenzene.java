...
public class Nitrobenzene extends JFrame implements ActionListener {
    ...
    Nitrobenzene() {
        ...
        JTextArea heading = new JTextArea("Nitrobenzene 35% Best Flowering Stimulant");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Increase Root Growth, Water Holding Capacity, ");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/21.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 516/-");
       ...
       tab.addTab("Nitrobenzene", null,p1);
       add(tab);
