...
public class manurefertilizerm1 extends JFrame implements ActionListener {
    ...
    manurefertilizerm1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char29.png"));
