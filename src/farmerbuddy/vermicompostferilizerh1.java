...
public class vermicompostferilizerh1 extends JFrame implements ActionListener {
    JButton back2,back1,redy;
   

    
    
    vermicompostferilizerh1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char39.png"));
