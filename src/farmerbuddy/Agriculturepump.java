...
public class Agriculturepump extends JFrame implements ActionListener {
    ...
    Agriculturepump() {
        ...
        JTextArea heading = new JTextArea("Tcm Agriculture Pump,");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("TCM Agriculture Pump,, The TCM Agriculture Pump offered by us are widely used for irrigation. ");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 15));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea(" It is used for the artificial application of water to the land or soil to irrigate them properly. ");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/42.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 2500/-");
       ...
       tab.addTab("Agriculturepump", null,p1);
       add(tab);
