...
public class Ammoniumfertilizerh1 extends JFrame implements ActionListener {
    JButton back2,back1,redy;
   

    
    
    Ammoniumfertilizerh1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char46.png"));
