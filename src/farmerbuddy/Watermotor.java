...
public class Watermotor extends JFrame implements ActionListener {
    ...
    Watermotor() {
        ...
        JTextArea heading = new JTextArea("Low Maintenance And High Pressure Sky Blue Monoblock Water Pumps");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("This water pump is a colour sky blue monoblock water pump. It has a 1/2 hp and 1800 rpm motor");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("that is able to move water at up to 6000 gallons per hour.");
