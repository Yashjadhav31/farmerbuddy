...
public class organic extends JFrame implements ActionListener {
    ...
    organic() {
        ...
        JTextArea heading = new JTextArea("NATURES PLUS Organic Fertiliser, 1 Kg");
...
p1.add(heading3);
       ...
       JTextArea heading4 = new JTextArea("rand	TrustBasket\n" +
"Item Weight	5000 Grams\n" +
"Item Form	Powder ");
       heading4.setBounds(30, 160, 600, 55);
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/25.png"));
       Image i2 = i1.getImage().getScaledInstance(400, 300, Image.SCALE_DEFAULT);
       ImageIcon i3 = new ImageIcon(i2);
       JLabel icon = new JLabel(i3);
       icon.setBounds(500, 270, 400, 300);
       p1.add(icon);
       ...
       JTextArea heading7 = new JTextArea("Rs 66/-");
