...
public class Capcicumseeds extends JFrame implements ActionListener {
    ...
    Capcicumseeds() {
        ...
        JTextArea heading = new JTextArea("Clause Ambika F1 Capsicum Seeds,");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Product Highlights: Brand: Clause Variety: Ambika F1 Fruit");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Characteristics: Fruit Size: Medium Fruit Color: Green Fruit Weight:");
       heading3.setBounds(30, 110, 800, 100);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);
       
       JTextArea heading4 = new JTextArea("150-180 Gm Fruit Shape: Blocky First Harvest: 60-65 days after transplanting");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/33.png"));
       ...
       tab.addTab("Capcicumseeds", null,p1);
       add(tab);
