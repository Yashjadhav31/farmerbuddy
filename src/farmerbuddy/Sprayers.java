...
public class Sprayers extends JFrame implements ActionListener {
    ...
    Sprayers() {
        ...
        JTextArea heading = new JTextArea("Made in India 16L Double Pressure Chamber Manual Knapsack Sprayer");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Knapsack Sprayer,backpack sprayer,manual sprayer,agriculture sprayer, ");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Agriculture manual Sprayer,Agriculture Manual Sprayer,pesticide sprayer,\nchemical sprayer,pesticide Manual sprayer ");
       heading3.setBounds(30, 100, 800, 40);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);
       
       JTextArea heading4 = new JTextArea("chemical Manual sprayer,distributor of manual sprayer,dealer of manual sprayer. ");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/5.png"));
       ...
       icon.setBounds(500, 220, 400, 300);
       p1.add(icon);
       ...
       JTextArea heading7 = new JTextArea("Rs 999/-");
