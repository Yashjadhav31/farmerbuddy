...
public class Farmingboot extends JFrame implements ActionListener {
    ...
    Farmingboot() {
        ...
        JTextArea heading = new JTextArea("VIPFARMER Farmer Safety Shoes");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Paddy Shoes|Rain Boots |Agriculture Shoes");
       heading2.setBounds(30, 60, 300, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Sole: Polyvinyl Chloride.\n" +
"Closure: Pull On.\n" +
"Shoe Width: Medium.\n" +
"Farmer Safety Shoes: These shoes are specifically designed to provide safety and protection for farmers working in agricultural environments.");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/38.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 780/-");
       ...
       tab.addTab("Farmingboot", null,p1);
       add(tab);
