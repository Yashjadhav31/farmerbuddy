...
public class Baler extends JFrame implements ActionListener {
    ...
    Baler() {
        ...
        JTextArea heading = new JTextArea("Vijay 10 HP Baler for Agriculture Purpose");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("model Garent 249 ");
...
p1.add(heading3);
       ...
       JTextArea heading4 = new JTextArea("The tractor has a multi-speed power take-off (PTO), enhancing its functionality and versatility. ");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/18.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 500000/-");
