...
public class Wheelbarrow extends JFrame implements ActionListener {
    ...
    Wheelbarrow() {
        ...
        JTextArea heading = new JTextArea("Wheel Barrow-Swastik Agro(Melasty)");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Brand	Generic\n" +
"Material	Metal\n" +
"Colour	Blue\n" +
...
p1.add(heading2); 
       ...
       JTextArea heading3 = new JTextArea("About this item\n" +
"Excellent Quality\n" +
"Easy To Operate\n" +
"Robust Design");
       heading3.setBounds(30, 200, 800, 80);
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/13.png"));
       ...
       tab.addTab("Wheelbarrow", null,p1);
       add(tab);
