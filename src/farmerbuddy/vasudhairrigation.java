...
public class vasudhairrigation extends JFrame implements ActionListener {
    ...
    vasudhairrigation() {
        ...
        JTextArea heading = new JTextArea("Vasudha Irrigation 1/2 IINCH VENTURI FULL KIT Drip Irrigation Kit () ");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Order Vasudha Irrigation 1/2 IINCH VENTURI FULL KIT ");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Drip Irrigation Kit () online at Jiomart and save.");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/41.png"));
       ...
       tab.addTab("vasudhairrigation", null,p1);
       add(tab);
