...
public class Redgram extends JFrame implements ActionListener {
    ...
    Redgram() {
        ...
        JTextArea heading = new JTextArea("Whole Red Gram Seeds-Kandulu-Cultivation");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Round Shape , Deep Red Color.");
       heading2.setBounds(30, 60, 300, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea(" Organically grown without pesticides and fertilizers\n" +
"Organic arhar dal is trusted by local consumers for being the healthiest choice of protein for their family and infants\n" +
"Makes tasty dal tadka\n" +
"Easy to cook\n" +
"High protein content\n" +
"Makes healthy khichadi after mixing with Rice.");
       heading3.setBounds(30, 110, 800, 120);
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/35.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 235/-");
