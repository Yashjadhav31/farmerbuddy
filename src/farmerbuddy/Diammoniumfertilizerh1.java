...
public class Diammoniumfertilizerh1 extends JFrame implements ActionListener {
    JButton back2,back1,redy;
   

    
    
    Diammoniumfertilizerh1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char43.png"));
