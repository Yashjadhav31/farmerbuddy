...
public class compostfertilizerh1 extends JFrame implements ActionListener {
    ...
    compostfertilizerh1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char41.png"));
