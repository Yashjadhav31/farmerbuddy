...
public class Tracktor extends JFrame implements ActionListener {
    ...
    Tracktor() {
        ...
        JTextArea heading = new JTextArea("Vijay 10 HP Mini Tractor for Agriculture Purpose");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Mini Tractor for Agriculture Purpose ");
