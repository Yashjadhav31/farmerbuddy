...
public class nitratefertilizerm1 extends JFrame implements ActionListener {
    ...
    nitratefertilizerm1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char48.png"));
