...
public class Diammoniumfertilizerm1 extends JFrame implements ActionListener {
    JButton back2,back1,redy;
   

    
    
    Diammoniumfertilizerm1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char44.png"));
