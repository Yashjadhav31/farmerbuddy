...
public class Chaftfcutter extends JFrame implements ActionListener {
    ...
    Chaftfcutter() {
        ...
        JTextArea heading = new JTextArea("Color Coated Carbon Steel 2250 Rpm Speed ");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("2 Hp Electrical Automatic Chaff Cutter For Agriculture");
       heading2.setBounds(30, 60, 800, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Product Type	Chaff Cutter\n" +
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/39.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 4500/-");
       ...
       tab.addTab("Chaftfcutter", null,p1);
       add(tab);
