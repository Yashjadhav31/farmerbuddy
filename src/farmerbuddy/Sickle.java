...
public class Sickle extends JFrame implements ActionListener {
    ...
    Sickle() {
        ...
        JTextArea heading = new JTextArea("JDB Wooden Handle Heavy Pruning Curved Sickle Light");
       heading.setBounds(50, 05, 500, 20);
       heading.setForeground(BLUE);
       heading.setFont(new Font("Tahoma", Font.BOLD, 20));
      
       p1.add(heading);
       
        JTextArea heading2 = new JTextArea("Weight for Gardening and Agriculture purpose 17 Inch ");
       heading2.setBounds(30, 60, 500, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Order JDB Wooden Handle Heavy Pruning Curved Sickle Light Weight\n for Gardening and Agriculture purpose \n17 Inch online at Jiomart and save. ");
       heading3.setBounds(30, 110, 800, 40);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);
       
       JTextArea heading4 = new JTextArea("Features & Details\n" +
"sickle\n" +
"hand sickle\n" +
"garden sickle ");
       heading4.setBounds(30, 150, 600, 80);
...
JTextArea heading5 = new JTextArea("The company’s manufacturing base in Jalandhar has put it as a bright spot \n on the World map of hand tool manufacturers. ");
       heading5.setBounds(30, 240, 600, 50);
