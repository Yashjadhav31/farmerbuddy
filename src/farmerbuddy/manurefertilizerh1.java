...
public class manurefertilizerh1 extends JFrame implements ActionListener {
    ...
    manurefertilizerh1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char30.png"));
