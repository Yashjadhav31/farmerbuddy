...
public class Plough extends JFrame implements ActionListener {
    ...
    Plough() {
        ...
        JTextArea heading = new JTextArea("Mild Steel 5 Bottom Plough, for Agriculture");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Usage/Application	\n" +
"Agriculture\n" +
"Material	\n" +
"Mild Steel\n" +
"Color	\n" +
...
p1.add(heading2); 
       ...
       heading3.setBounds(30, 240, 800, 30);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);
       
       JTextArea heading4 = new JTextArea("it is use for farming ");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/11.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 40000/-");
