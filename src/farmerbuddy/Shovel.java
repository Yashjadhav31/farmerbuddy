...
public class Shovel extends JFrame implements ActionListener {
    ...
    Shovel() {
        ...
        JTextArea heading = new JTextArea("Mengshi brand large shovel manganese");
       heading.setBounds(50, 05, 300, 20);
       heading.setForeground(BLUE);
       heading.setFont(new Font("Tahoma", Font.BOLD, 20));
      
       p1.add(heading);
       
        JTextArea heading2 = new JTextArea("steel outdoor vehicle square round steel shovel");
       heading2.setBounds(30, 60, 300, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Used for digging in clay or hard pan\n" +
"Can also be used for digging hard packed gravel and dirt\n" +
"Fits Bosch SDS-Max hammers, competitive SDS-Max driver hammers and Hilti hammers using TE-Y and\n TE-FY shanks\n" +
"Not for use in concrete");
       heading3.setBounds(30, 110, 800, 80);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);
       
       JTextArea heading4 = new JTextArea("Bosch HS1922 4-1/2\" x 17\" SDS-Max Clay Spade ");
       heading4.setBounds(30, 150, 600, 30);
       heading4.setFont(new Font("Tahoma", Font.BOLD, 15));
heading.setForeground(RED);
p1.add(heading4);

JTextArea heading5 = new JTextArea("The company’s manufacturing base in Jalandhar has put it as a bright spot \n on the World map of hand tool manufacturers. ");
       heading5.setBounds(30, 230, 600, 50);
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/2.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 399/-");
