...
public class Cultivator2 extends JFrame implements ActionListener {
    ...
    Cultivator2() {
        ...
        JTextArea heading = new JTextArea("NINE TINE RIGID CULTIVATOR (CK9TRC)");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/17.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 35000/-");
