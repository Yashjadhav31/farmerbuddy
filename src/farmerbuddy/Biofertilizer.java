...
public class Biofertilizer extends JFrame implements ActionListener {
    ...
    Biofertilizer() {
        ...
        JTextArea heading = new JTextArea("ROM Azospirillum Liquid Bio-Fertilizer, Nitrogen Fixing Bacterium");
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/23.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 600/-");
       ...
       tab.addTab("Biofertilizer", null,p1);
       add(tab);
