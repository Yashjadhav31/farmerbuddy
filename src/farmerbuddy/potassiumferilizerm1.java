...
public class potassiumferilizerm1 extends JFrame implements ActionListener {
    JButton back2,back1,redy;
   

    
    
    potassiumferilizerm1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char33.png"));
