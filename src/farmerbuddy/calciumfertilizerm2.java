...
public class calciumfertilizerm2 extends JFrame implements ActionListener {
    ...
    calciumfertilizerm2() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char36.png"));
