...
public class Npkchemical extends JFrame implements ActionListener {
    ...
    Npkchemical() {
        ...
        JTextArea heading = new JTextArea("ROM Azospirillum Liquid Npkchemical, Nitrogen Fixing Bacterium");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("And Vegetables For Fast Growth And Flowering.");
       heading2.setBounds(30, 60, 300, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Improves soil aeration\n" +
...
p1.add(heading3);
       ...
       JTextArea heading4 = new JTextArea("Product Name : Azospirillum\n" +
"Product Type : Bio-Fertilizer\n" +
"Brand : ROM\n" +
"Quantity : 1 ltr");
       heading4.setBounds(30, 160, 600, 75);
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/24.png"));
       Image i2 = i1.getImage().getScaledInstance(300, 300, Image.SCALE_DEFAULT);
       ImageIcon i3 = new ImageIcon(i2);
       JLabel icon = new JLabel(i3);
       icon.setBounds(500, 260, 300, 300);
       p1.add(icon);
       ...
       JTextArea heading7 = new JTextArea("Rs 500/-");
       ...
       tab.addTab("Npkchemical", null,p1);
       add(tab);
