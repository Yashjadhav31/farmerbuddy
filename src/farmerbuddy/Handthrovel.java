...
public class Handthrovel extends JFrame implements ActionListener {
    ...
    Handthrovel() {
        ...
        JTextArea heading = new JTextArea("Yuvismart Flower Wide Trowel");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("for Garden Hand Trowel/Transplanter/Hand Soil Shovel");
       heading2.setBounds(30, 60, 800, 120);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Made in india ");
       heading3.setBounds(30, 150, 800, 30);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);
       
       JTextArea heading4 = new JTextArea("6.5-inch long trowel plus plastic handle extra\n" +
"Package Contents: 1-Piece Trowel\n" +
"Light weight and Rust Preventive Coating");
       heading4.setBounds(30, 220, 800, 100);
...
JTextArea heading5 = new JTextArea("The company’s manufacturing base in Jalandhar has put it as a bright spot \n on the World map of machine tool manufacturers. ");
       heading5.setBounds(30, 180, 600, 50);
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/14.png"));
       ...
       heading6.setBounds(80, 310, 300, 30);
       heading6.setForeground(RED);
       heading6.setFont(new Font("Tahoma", Font.BOLD, 30));
      
       p1.add(heading6);
       
       JTextArea heading7 = new JTextArea("Rs 400/-");
       ...
       tab.addTab("Handthrovel", null,p1);
       add(tab);
