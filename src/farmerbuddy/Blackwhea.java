...
public class Blackwhea extends JFrame implements ActionListener {
    ...
    Blackwhea() {
        ...
        JTextArea heading = new JTextArea("VILLKART NATURALS Black Wheat/Kala Gehu Seeds for Sowing,");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("Farming & Agriculture (Kheti खेती) 10kg");
       heading2.setBounds(30, 60, 300, 30);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 20));
heading2.setForeground(RED);     
p1.add(heading2); 
       
       JTextArea heading3 = new JTextArea("Black Wheat Seeds (Use for Farming Purpose) Black Wheat is Rich in Anthocyanins .");
       heading3.setBounds(30, 110, 800, 20);
       heading3.setFont(new Font("Tahoma", Font.BOLD, 15));
heading3.setForeground(BLUE);      
p1.add(heading3);
       
       JTextArea heading4 = new JTextArea(" have higher dietary fibres and at least 15% fewer carbohydrates than conventional wheat.");
       heading4.setBounds(30, 220, 800, 20);
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/34.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 199/-");
