...
public class potassiumferilizerh2 extends JFrame implements ActionListener {
    JButton back2,back1,redy;
   

    
    
    potassiumferilizerh2() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char32.png"));
