...
public class compostfertilizerm1 extends JFrame implements ActionListener {
    ...
    compostfertilizerm1() {
       ...
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/char42.png"));
