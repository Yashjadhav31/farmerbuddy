...
public class Crowbar extends JFrame implements ActionListener {
    ...
    Crowbar() {
        ...
        JTextArea heading = new JTextArea("Crowbar");
       ...
       p1.add(heading);
        ...
        JTextArea heading2 = new JTextArea("a heavy iron bar with a bent end that is used to help lift "
                + "/n heavy objects off the ground or to force things open: ");
       heading2.setBounds(30, 60, 800, 50);
       heading2.setFont(new Font("Tahoma", Font.BOLD, 12));
...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/16.png"));
       ...
       JTextArea heading7 = new JTextArea("Rs 300/-");
